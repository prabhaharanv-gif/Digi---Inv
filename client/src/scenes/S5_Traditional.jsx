        ...
        <div style={{ padding:2.5, background:'linear-gradient(135deg,#b8860b,#f9f0d0,#d4a843,#8b6508,#e8c97a)', borderRadius:10 }}>
          <div style={{
            ...
            <div style={{ position:'relative', zIndex:1 }}>
              ...
              <GoldDivider />
              <div style={{ fontFamily:"'Cormorant Garamond',serif", fontStyle:'italic', fontWeight:300, fontSize:'clamp(0.72rem,2.2vw,0.85rem)', color:'#4a6e44', lineHeight:1.85, margin:'0.6rem 0' }}>
              ...
              <div style={{ fontFamily:"'Cormorant Garamond',serif", fontStyle:'italic', fontSize:'clamp(0.68rem,2vw,0.8rem)', color:'#7aac72', lineHeight:1.8 }}>
                Son of Thiru. {f[0]?.name} &amp; Thirumathi. {f[1]?.name}<br/>
                with the beloved daughter of<br/>
                Thiru. {f[2]?.name} &amp; Thirumathi. {f[3]?.name}
              </div>
              <GoldDivider />
              <div style={{ fontFamily:"'Playfair Display',serif", fontSize:'clamp(0.62rem,1.8vw,0.75rem)', color:'#c9922a', letterSpacing:'2px', margin:'0.5rem 0 0.3rem', fontWeight:500 }}>
                25 DECEMBER 2026 · 9:30 AM
              </div>
              <div style={{ fontFamily:"'Lato',sans-serif", fontWeight:300, fontSize:'clamp(0.62rem,1.8vw,0.72rem)', color:'#7aac72', lineHeight:1.6 }}>
                {event?.venue}<br/>{event?.venueAddress}
              </div>
              <GoldDivider />
              <div style={{ fontFamily:"'Cormorant Garamond',serif", fontStyle:'italic', fontSize:'clamp(0.65rem,1.8vw,0.75rem)', color:'rgba(74,110,68,0.6)' }}>
